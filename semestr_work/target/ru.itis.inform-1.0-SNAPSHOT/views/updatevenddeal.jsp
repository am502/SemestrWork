    ...
    <form action="" method="post">
        <div class="input-group input-group-lg">
            ...
            <div class="form-group">
                ...
                <input type="text" pattern="[]|([1-9][0-9]*)" id="lotSizeWholesale" name="lotSizeWholesale" class="form-control">
            </div>
            <div class="form-group">
                <label for="price">Цена:</label>
                <input type="text" id="price" pattern="[]|([1-9][0-9]*)" name="price" class="form-control">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="conditionsSale" name="conditionsSale" class="form-control">
            </div>
            <div class="form-group">
